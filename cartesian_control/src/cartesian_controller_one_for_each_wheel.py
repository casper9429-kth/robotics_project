...
class cartesian_controller:
    ...
    def run(self):
        ...
        * gets wheel velocities from encoder feedback and PI control
        ...
        while not rospy.is_shutdown(): # insted of while True, makes sure ros dies when supposed to
            ...
            #duty_cycle_msg.duty_cycle_left = self.v_left_des#self.PID_left(self.v_left_des, self.v_left_enco)
            #duty_cycle_msg.duty_cycle_right = self.v_right_des#self.PID_right(self.v_right_des, self.v_right_enco)
    ...
    def PID_left(self,des_spd,cur_spd):
    ...
    def PID_right(self,des_spd,cur_spd):
